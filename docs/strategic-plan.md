...
**Status:** Living planning document · May 2026 · v1.0  
**Scope:** Mission, artifacts, phases, roadmap, and capability inventory for the broader Vitiligo Initiative — not only the Evidence Engine code in this repository.
...
Gate conditions:
- [ ] Mission and objectives document finalized (this strategic plan is v1)
...
Gate conditions:
- [ ] Top 5–10 candidates ranked with full rationale ([`candidate-report-v1.md`](candidate-report-v1.md) — deterministic v1; advisor + LLM review pending)
...
- **Planning artifact** — this document (plus linked briefs below).
- **AI engine v1.0 — Evidence Engine + Knowledge Graph:**
  ...
  - **Web UI** (`vitiligo serve`) — FastAPI Evidence Engine with Search / Ask / Hypothesize / Graph / Trials tabs. **Local-first for now** (`vitiligo serve` + KOL screen share). Public hosting planned on **DigitalOcean** — see [`deploy.md`](deploy.md).
...
When this matures and stabilizes, sections will split into purpose-built documents (dedicated mission statement, funder brief, etc.). For now, this file holds initiative-wide thinking; the [README](../README.md) stays focused on the open-source Evidence Engine.
