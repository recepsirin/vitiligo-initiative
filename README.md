...
- **AI engine v0.6 — Evidence Engine, end-to-end:**
  ...
  - **Typed CLI**, ruff-clean, 34 tests passing, Apache-2.0 licensed.
...
2. Add **DrugBank** ingestion (open subset) for mechanism/pathway priors.
...
5. **Public deployment** of the Evidence Engine (Fly.io / Render) with rate limiting and telemetry.
6. In parallel: draft the **Scientific Brief** and the **Governance & Ethics Brief**.
